...
const Footer = () => {
    ...
    return (
        <div id="footer">
            <div className="logo">
                <Link to="/">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 171 210" className='sidebar__logo' style={{ backgroundColor: 'transparent' }}>
            ...
            <div className="githubChart" data-aos="zoom-in">
                <div className="dates">
                    <span>Jan</span>
                    <span>Feb</span>
                    <span>Mar</span>
            ...
            <div className="copyright"><p>Copyright &copy; 2023 Aaryan Pinto</p></div>
        </div>
    )
}
